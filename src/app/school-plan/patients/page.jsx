...
const AllPatientsSchoolPlan = () => {
  ...
  useEffect(() => {
    fetchSchoolPlanPatients();
  }, [currentPage, search]);

  const fetchSchoolPlanPatients = async () => {
    setLoading(true);
    try {
      const response = await axiosInstance.get(
        `/school/school-assignments?page=${currentPage}&search=${search}`
      );
      ...
      console.error("Error fetching school patients:", error);
      setAssignments([]);
    } finally {
      setLoading(false);
    }
    ...
    <div className="card h-100 p-0 radius-12">
      <div className="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center flex-wrap gap-3 justify-content-between">
        <div className="d-flex align-items-center flex-wrap gap-3">
          <h6 className="text-lg mb-0">School Department Patients</h6>
      ...
      <div className="card-body p-24">
        {loading ? (
          ...
          <div className="text-center py-4">
            <p className="text-muted">No patients assigned to school </p>
            <button
              onClick={() => router.push("/school-plan/assign-patients")}
                    ...
                    <td className="text-center">
                      <div className="d-flex align-items-center gap-10 justify-content-center">
                        <button
                          onClick={() =>
                            router.push(
                              `/school-plan/plan/${assignment.patient?._id}`
                            )
                          }
                          type="button"
        ...
        <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-24">
          <span className="text-gray-900">
            Showing {assignments.length} school department patients
          </span>
...
export default AllPatientsSchoolPlan;

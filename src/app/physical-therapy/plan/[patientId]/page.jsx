...
const PatientPlanEditor = () => {
  ...
  const fetchExistingPlan = async () => {
    try {
      const response = await axiosInstance.get(`${process.env.NEXT_PUBLIC_API_URL}/authentication/physical-therapy/plan/${patientId}`)
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/authentication/physical-therapy/plan`, planData)
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/authentication/py/upload-plan`, formData, {
  ...
  const handleDownloadDocument = () => {
    if (plan.filePath) {
      window.open(`${process.env.NEXT_PUBLIC_API_URL}/physical-therapy/download-plan/${plan.filePath}`, "_blank")
    }
  }
